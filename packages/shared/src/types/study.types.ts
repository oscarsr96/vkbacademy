...
// Dificultad de generación. Gobierna la generación de ejercicios y examen.
export type StudyDifficulty = 'EASY' | 'MEDIUM' | 'HARD';

// Ejercicio persistido en el plan (misma forma que genera ExercisesService).
...
// ── Plan de estudio (StudyPlan) ──
// Combina 1..N temas (oficiales del temario o libres) en teoría por tema +
// ejercicios y examen combinados. Es el flujo único de estudio.
