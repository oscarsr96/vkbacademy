...
// las plataformas. Mismo patrón que el registro de marketing (que mantiene su
// propia copia: PublicLayout/marketing no se tocan desde el app autenticado).
export const ICONS: Record<string, string> = {
  ...
  whistle:
    '<circle cx="8.5" cy="14.5" r="5.5"/><path d="M12.2 10.4 20.5 7.5v5.2l-4.8 1.6"/><path d="M8.5 3.5v3"/>',
  shirt:
